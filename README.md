...
> Set up a React app to consume the 'hello-rails-back-end' API
...
```sh
  cd my-folder
  git clone git@github.com:kensteph/hello-rails-front-end.git
```
...
### Back-end
[hello-rails-back-end](https://github.com/kensteph/hello-rails-back-end)
